...
/**
 * @slot default-anchor - The default anchor element for the popover menu. This will take precedence over the `anchor` prop.
 */
@Component({
  tag: "ic-popover-menu",
...
export class PopoverMenu {
  ...
  render() {
    return (
      ...
      >
        {isSlotUsed(this.el, "default-anchor") && (
          <slot name="default-anchor"></slot>
        )}
        <div
          class={{
